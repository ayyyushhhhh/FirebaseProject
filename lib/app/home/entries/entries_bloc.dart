import 'package:firebase_course/app/home/entries/daily_jobs_details.dart';
import 'package:firebase_course/app/home/entries/entries_list_tile.dart';
import 'package:firebase_course/app/home/entries/entry_job.dart';
  ...
  static List<EntryJob> _entriesJobsCombiner(
    ...
    return entries.map((entry) {
      final job = jobs.firstWhere(
        (job) => job.documentId == entry.jobId,
        orElse: () => null,
      );
